...
namespace com.mosso.cloudfiles.unit.tests.Domain.request.DeleteContainerSpecs
{
    ...
    public class when_deleting_a_container_and_storage_url_is_null
    {
        ...
        {
            new DeleteContainer(null, "storagetoken", "containername");
        }
    }
    ...
    public class when_deleting_a_container_and_storage_url_is_emptry_string
    {
        ...
        public void should_throw_argument_null_exception()
        {
            new DeleteContainer("", "storagetoken", "containername");
        }
    }

    [TestFixture]
    public class when_deleting_a_container_and_storage_token_is_null
    {
        [Test]
        [ExpectedException(typeof(ArgumentNullException))]
        public void should_throw_argument_null_exception()
    ...
    [TestFixture]
    public class when_deleting_a_container_and_storage_token_is_emptry_string
    {
        [Test]
        [ExpectedException(typeof(ArgumentNullException))]
        public void should_throw_argument_null_exception()
    ...
    public class when_deleting_a_container_and_container_name_is_null
    {
        ...
        public void should_throw_argument_null_exception()
        {
            new DeleteContainer("http://storageurl", "storagetoken", null);
        }
    }
    ...
    public class when_deleting_a_container_and_container_name_is_emptry_string
    {
        ...
        public void should_throw_argument_null_exception()
        {
            new DeleteContainer("http://storageUrl", "storagetoken", "");
        }
    }
    ...
    public class when_deleting_a_container
    {
        ...
        public void setup()
        {
            deleteContainer = new DeleteContainer("http://storageurl", "storagetoken", "containername");
        }
        ...
        {
            Assert.That(deleteContainer.Headers[cloudfiles.Constants.X_STORAGE_TOKEN], Is.EqualTo("storagetoken"));
        }
    }
}
...
namespace com.mosso.cloudfiles.domain.request
{
    public class SetPublicContainerDetailsRequest : BaseRequest
    {
        ...
        public SetPublicContainerDetailsRequest(string cdnManagementUrl, string authToken, string containerName, bool isCdnEnabled)
        {
            AssignCommonDetails(cdnManagementUrl, authToken, containerName);

            var isCdnEnabledString = isCdnEnabled.ToString();
        ...
        private void AssignCommonDetails(string cdnManagementUrl, string authToken, string containerName)
        {
            AssignCommonDetails(cdnManagementUrl, authToken, containerName);
        }
